...
const columns: ColumnDefinition<LogEntry>[] = [
    ...
    { header: 'Service', accessor: 'service', width: '150px', sortable: true, filterable: true },
...
const detailsFieldRenderers: DetailsFieldRenderer<LogEntry>[] = [
    {
        field: 'level',
        render: (value) => <LogLevelBadge level={value as LogEntry['level']}>{String(value)}</LogLevelBadge>
    },
    {
        field: 'timestamp',
